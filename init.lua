...
vim.cmd "autocmd BufEnter,WinEnter term://* startinsert"

-- [[ Basic Keymaps ]]
--  See `:help vim.keymap.set()`

-- Press <Esc> to clear message line and search highlights in normal mode.
--  See `:help hlsearch`
...
-- vim.keymap.set("n", "<C-S-l>", "<C-w>L", { desc = "Move window to the right" })Add commentMore actions
...
require('lazy').setup({
  ...
  -- Luvit-Meta is a collection of definition files for the Lua async I/O
  -- framework Luvit (https://luvit.io/).
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to the definition of the word under your cursor.Add commentMore actions
          ...
          -- Jump to the type of the word under your cursor.Add commentMore actions
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      require('tokyonight').setup {
        ...
        --- You can override specific color groups to use other groups or a
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'cpp', 'java', 'javascript', 'typescript', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
